<?php
    function updating_to_receipts($selected_name,$selected_sheet,$conn)
    {
		$flg = false;
            ...
            foreach($selected_sheet as $rowValues){
                ...
                foreach($rowValues as $key => $rowValue){
                    ...
                    if($arr[0]!="''"){
                        ...
                        if($flg){
                            $query = "INSERT INTO receipts (date, customerName, voucherType, voucherNumber, amount, validated) 
                                VALUES (".$arr[$required[0]].", ".$arr[$required[1]].", 'saleReturn', ".$arr[$required[2]].", ".$arr[$required[3]].", '0')";
